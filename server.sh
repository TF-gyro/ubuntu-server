...
sudo cp /var/www/html/xyz.wildfire.world/nginx.conf /etc/nginx/sites-available/xyz.wildfire.world;
sudo sed -i 's/your_server_ip/ipv4_address/g' /etc/nginx/sites-available/xyz.wildfire.world;
sudo sed -i 's/your_server_domain/xyz.wildfire.world/g' /etc/nginx/sites-available/xyz.wildfire.world;
sudo ln -s /etc/nginx/sites-available/xyz.wildfire.world /etc/nginx/sites-enabled/xyz.wildfire.world;
sudo cp /var/www/html/xyz.wildfire.world/apache2.conf /etc/apache2/sites-available/xyz.wildfire.world.conf;
sudo sed -i 's/your_server_domain/xyz.wildfire.world/g' /etc/apache2/sites-available/xyz.wildfire.world.conf;
a2ensite xyz.wildfire.world;
sudo systemctl reload nginx;
sudo service apache2 start;
sudo snap install --classic certbot;
sudo certbot --agree-tos --no-eff-email --email tech@wildfire.world --nginx -d xyz.wildfire.world -d www.xyz.wildfire.world;