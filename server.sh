...
echo 'post_max_size = 1024M' | tee -a /etc/php/8.3/fpm/php.ini;
echo 'upload_max_filesize = 1024M' | tee -a /etc/php/8.3/fpm/php.ini;
echo 'memory_limit = 2048M' | tee -a /etc/php/8.3/fpm/php.ini;
